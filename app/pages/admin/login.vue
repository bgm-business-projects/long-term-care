  ...
  <div class="min-h-screen flex items-start justify-center bg-default px-4 pt-[10vh]">
    <div class="w-full max-w-sm space-y-6">
      <div class="text-center space-y-2">
        ...
        <p class="text-sm text-muted">管理後台登入</p>
      </div>

      <UCard>
        <div class="space-y-4">
          <h2 class="text-lg font-semibold text-center text-highlighted">管理員登入</h2>
      ...
      <div class="flex justify-center gap-4 text-xs text-muted">
        ...
        <span>·</span>
        <NuxtLink to="/driver/login" class="text-primary hover:underline">司機登入</NuxtLink>
      </div>
    </div>
  </div>
</template>
